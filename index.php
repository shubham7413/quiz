...
<script>
    ...
    <?php
    if (isset($_SESSION['status_session']) == '1') {
    ...
    <script>
        if ((<?php echo $_SESSION['status_session']; ?>) == 1) {
        ...
        function wrong(detail) {
            document.getElementById('game-end-detail').innerHTML = detail;
